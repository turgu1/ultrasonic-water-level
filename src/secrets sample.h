// This is a sample file showing the macro definitions that must
// me completed with the appropriate information.
//
// This is done to hide the sensitive information from the GitHub
// platform.
//
// Once completed, this file must be renamed "secrets.h"
...
#define OTA_AUTH "<MD5-HASHED-PASSWORD>"

#define LOGGER_PORT 1234